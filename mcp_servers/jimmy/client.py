...
from mcp_servers.jimmy.config import GHL_API_KEY, GHL_BASE_URL, GHL_API_VERSION, GHL_LOCATION_ID
...
class GHLClient:
    ...
    async def get(self, path: str, params: dict | None = None, inject_location: bool = True) -> dict:
        if inject_location:
