---
description: Alias for the current MCP push command - commit, push, and verify the active project on Vercel
---

# Push to Prod Jimmy - Alias for Current MCP Project

This command is a compatibility alias for [mcp-push](./mcp-push.md).

Use it when you want the same project-aware deployment workflow under the older `/pushtoprodjimmy` name.
